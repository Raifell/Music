...
class MusicGenre(models.Model):
    ...
    def save(self, force_insert=False, force_update=False, using=None, update_fields=None):
        if not self.slug:
            self.slug = slugify('{}'.format(self.genre))
    ...
    def get_absolute_url(self):
        return reverse('bands_page', kwargs={'genre': self.genre})
...
class MusicBand(models.Model):
    ...
    def save(self, force_insert=False, force_update=False, using=None, update_fields=None):
        if not self.slug:
            self.slug = slugify('{}-{}'.format(self.name, self.genre))
        super().save(force_insert, force_update, using, update_fields)
    ...
    def get_absolute_url(self):
        return reverse('info_page', kwargs={'genre': self.genre.genre, 'slug': self.slug})
